...
/**
 * this class is communicate between the model  and the view of ViewShowGrade class.
 */

public class ViewModelShowGrade implements IViewModel {
    ...
    public void setName(String name) {
        this.iModel.setName(name);

    }
    @Override
    public void setWhatOrder(String whatOrder) {
       this.iModel.setWhatOrder(whatOrder);
    }

    @Override
    public String getWhatOrder() {
        return this.iModel.getWhatOrder();
    }
    ...
    public Object[][] printTableShowGrades(String sql,int row) throws SQLException {
        return iModel.printTableShowGrades(sql, row);
    }

    @Override
    public int numbersOfRows(String nameTable) throws SQLException {
        return iModel.numbersOfRows(nameTable);
    }

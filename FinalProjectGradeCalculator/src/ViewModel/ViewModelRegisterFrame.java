...
/**
 * this class is communicate between the model  and the view of ViewRegisterFrame class.
 */

public class ViewModelRegisterFrame implements IViewModel {
    ...
    public boolean checknameInTheTable(String name) throws SQLException {
        if(iModel.checknameInTheTable(name)){
            return true;
        }
        return false;
    }
